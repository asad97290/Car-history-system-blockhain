...
function Data() {
  ...
  const url = "https://35.246.79.78:4000/channels/mychannel/chaincodes/fabcar";
  ...
  function singleFileUploadHandler(event) {
    ...
    if (selectedFile.selected) {
      ...
      axios
        .post("https://35.246.79.7800/profile-img-upload", data, {
          headers: {
  ...
  async function checkCar(vin) {
    const url3 = `https://35.246.79.7800/channels/mychannel/chaincodes/fabcar?args=["${vin}"]&fcn=queryCar`;
